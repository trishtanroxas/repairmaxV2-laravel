<div>
    ...
    <div x-data="{ showSuccess: false }" x-init="setTimeout(() => showSuccess = true, 50)">
        ...
        <div x-show="showSuccess"
            ...
            <div class="pt-4 space-y-4">
                <a href="/login" wire:navigate class="block w-full text-center bg-gray-900 text-gray-100 hover:bg-gray-800 font-medium rounded-md px-4 py-3 transition-colors shadow-sm">
                    Return to Log in
                </a>
            </div>
    ...
    <form wire:submit="sendResetLink" class="space-y-6">
        ...
        <div class="pt-2">
            <button type="submit"
                class="w-full bg-gray-900 hover:bg-gray-800 text-gray-100 font-medium rounded-md px-4 py-3 transition-colors shadow-sm relative flex justify-center items-center"
