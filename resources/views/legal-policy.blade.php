        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-element">
            <div class="flex flex-col lg:flex-row gap-10"
                ...
                <aside class="lg:w-1/4">
                    <div class="sticky top-32 bg-white/[0.03] backdrop-blur-md rounded-3xl p-6 border border-white/10 shadow-2xl">
                        <h3 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-4">Policies</h3>
                        <nav class="flex flex-col space-y-3">
                            <a href="#privacy"
                                @click="activeTab = '#privacy'"
                                class="flex items-center transition-colors"
                                :class="activeTab === '#privacy' ? 'text-white font-bold bg-white/5 p-2 rounded-lg' : 'text-gray-400 hover:text-white font-medium'">
                            ...
                            <a href="#terms"
                                ...
                                class="flex items-center transition-colors"
                                :class="activeTab === '#terms' ? 'text-white font-bold bg-white/5 p-2 rounded-lg' : 'text-gray-400 hover:text-white font-medium'">
                            ...
                            <a href="#refund"
                                ...
                                class="flex items-center transition-colors"
                                :class="activeTab === '#refund' ? 'text-white font-bold bg-white/5 p-2 rounded-lg' : 'text-gray-400 hover:text-white font-medium'">
                            ...
                            <a href="#warranty"
                                ...
                                class="flex items-center transition-colors"
                                :class="activeTab === '#warranty' ? 'text-white font-bold bg-white/5 p-2 rounded-lg' : 'text-gray-400 hover:text-white font-medium'">
                ...
                <div class="lg:w-3/4">
                    ...
                    <div x-show="activeTab === '#privacy'" x-cloak style="display: none;"
                        ...
                        class="bg-white/[0.03] backdrop-blur-md rounded-3xl p-8 md:p-10 border border-white/10 shadow-2xl">
                        <h2 class="text-3xl font-bold text-white mb-6 flex items-center">
                            <span class="material-symbols-outlined text-3xl mr-3 text-gray-300">shield</span>
                            Privacy Policy
                        </h2>
                        <div class="max-w-none text-gray-300 leading-relaxed space-y-4">
                            ...
                            <h3 class="text-xl font-bold text-white mt-6 mb-2">Data Protection on Devices</h3>
                            ...
                            <h3 class="text-xl font-bold text-white mt-6 mb-2">Information We Collect</h3>
                    ...
                    <div x-show="activeTab === '#terms'" x-cloak style="display: none;"
                        ...
                        class="bg-white/[0.03] backdrop-blur-md rounded-3xl p-8 md:p-10 border border-white/10 shadow-2xl">
                        <h2 class="text-3xl font-bold text-white mb-6 flex items-center">
                            <span class="material-symbols-outlined text-3xl mr-3 text-gray-300">gavel</span>
                            Terms of Service
                        </h2>
                        <div class="max-w-none text-gray-300 leading-relaxed space-y-4">
                            ...
                            <h3 class="text-xl font-bold text-white mt-6 mb-2">Abandoned Devices</h3>
                            ...
                            <h3 class="text-xl font-bold text-white mt-6 mb-2">Pre-existing Conditions</h3>
                    ...
                    <div x-show="activeTab === '#refund'" x-cloak style="display: none;"
                        ...
                        class="bg-white/[0.03] backdrop-blur-md rounded-3xl p-8 md:p-10 border border-white/10 shadow-2xl">
                        <h2 class="text-3xl font-bold text-white mb-6 flex items-center">
                            <span class="material-symbols-outlined text-3xl mr-3 text-gray-300">currency_exchange</span>
                            Refund Policy
                        </h2>
                        <div class="max-w-none text-gray-300 leading-relaxed space-y-4">
                            ...
                            <h3 class="text-xl font-bold text-white mt-6 mb-2">Labor and Diagnostic Fees</h3>
                            ...
                            <h3 class="text-xl font-bold text-white mt-6 mb-2">Parts Refunds</h3>
                    ...
                    <div x-show="activeTab === '#warranty'" x-cloak style="display: none;"
                        ...
                        class="bg-white/[0.03] backdrop-blur-md rounded-3xl p-8 md:p-10 border border-white/10 shadow-2xl">
                        <h2 class="text-3xl font-bold text-white mb-6 flex items-center">
                            <span class="material-symbols-outlined text-3xl mr-3 text-gray-300">verified</span>
                            Warranty Information
                        </h2>
                        <div class="max-w-none text-gray-300 leading-relaxed space-y-4">
                            <p>We stand by the quality of our OEM-grade parts and the expertise of our certified technicians.</p>
                            <div class="bg-white/[0.05] p-6 rounded-xl border border-white/10 my-6 shadow-md">
                                <h3 class="text-lg font-bold text-white mb-2">The Repairmax 90-Day Guarantee</h3>
                                <p class="text-sm text-gray-300">All standard repairs come with a comprehensive 90-day warranty against manufacturer defects in the replacement parts.</p>
                            </div>
                            <h3 class="text-xl font-bold text-white mt-6 mb-2">What is NOT Covered:</h3>
                            <ul class="list-disc pl-5 space-y-2">
